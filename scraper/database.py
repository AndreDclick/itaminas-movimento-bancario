...
#                 # Filtrar fornecedores excluídos
#                 mask = ~df['fornecedor'].str.contains('|'.join(self.settings.FORNECEDORES_EXCLUIR), case=False, na=False)
#                 df = df[mask]
...
#                     MAX(fornecedor) as descricao_fornecedor,  # Simplificado - ajustar conforme necessidade
